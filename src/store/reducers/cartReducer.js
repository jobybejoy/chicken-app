...
const cartReducer = (state = initState, action) => {
  switch (action.type) {
    ...
    case 'REMOVE_ITEM_FROM_CART':
      ...
      //   if (item.name === action.newItem.name) { return action.newItem }
      //   return item
      // })
      return {
        ...state,
